var livePage = {
    ...
    getDownUrl: function() {
        ...
        _this.downUrl_AN = $('#t_android_download').val();
        _this.downUrl_IOS=$('#t_ios_download').val();
        _this.userId=$('#userId').val();
        // if (_this.sysTemInfo() == 'ios') {
    ...
    down: function() {
        ...
        if (_this.isWeChat()) {
            ...
            var clipboard = new ClipboardJS('.copy_salq', {
                text: function () {
// 				alert("ok");
                    return "chat:userId=" + _this.userId;
                }
            });
        	on_click_doload();
...
//                //document.getElementById("").innerHTML=document.getElementById("qrcode");
//                window.location.href = "http://192.168.0.105:8088/share/qrcode.htm?userId=8";
//            } else {
//
...
//            });
//            if (_this.sysTemInfo() == 'ios') {
//                window.location.href = _this.downUrl_IOS;
